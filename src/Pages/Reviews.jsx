    ...
    <>
      ...
      <section className="review-section">
        ...
        <p className="review-desc">
          BlueHaven supports habit building, emotional awareness, mindful
            ...
            >
              {reviews.map((review, index) => (
                <div key={index} className="review-slide">
                  ...
                  <p className="review-author">_{review.name}/</p>
                </div>
              ))}
            </div>
        ...
        <section className="content-section">
          ...
          <p className="section-text">
            BlueHaven focuses on simplicity, clarity, and emotional well-being.
            Instead of overwhelming users with data or strict routines, it
            encourages mindful consistency and gentle self-reflection.
          </p>
          <p className="section-text">
            The platform is designed to feel safe and approachable, helping
            users return without guilt and progress at their own pace.
          </p>
        </section>
        <section className="content-section">
          <p className="section-text">
            Every journey looks different. BlueHaven supports users through
            small, meaningful steps, helping them build habits and awareness in
            a way that feels personal and sustainable.
          </p>
        </section>
      </section>
    </>
