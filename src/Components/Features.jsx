  ...
  return (
    <section className="features-section">
      <div className="features-header">
        <h2 className="features-title brand-font">Core Features</h2>
      ...
      <div className="features-cards">
        <div className="feature-card">
          ...
          <p>
            Build consistency by tracking your daily habits and routines
            mindfully.
          </p>
        ...
        <div className="feature-card">
          ...
          <p>Reflect on your emotions and understand patterns in your mood.</p>
          <Link to="/moodlog">
            <button>Explore</button>
          </Link>
        </div>
        <div className="feature-card">
          ...
          <p>Get gentle insights to help you make healthier digital choices.</p>
          <Link to="/insights">
